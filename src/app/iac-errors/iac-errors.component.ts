...
import { AutoScalingDetailComponent } from '../iac/auto-scaling-detail/auto-scaling-detail.component';
import { CommandGroup, CommandPlatform, getIacCommand } from '../iac/iac-command.model';
import { LoadBalancerAutoScalingDetailComponent } from '../iac/load-balancer-auto-scaling-detail/load-balancer-auto-scaling-detail.component';
...
@Component({
  selector: 'app-iac-errors',
  standalone: true,
  imports: [CommonModule, AutoScalingDetailComponent, LoadBalancerAutoScalingDetailComponent],
  templateUrl: './iac-errors.component.html',
  styleUrl: './iac-errors.component.css',
})
export class IacErrorsComponent {
